...
class ProjectAllocation(Base):
    ...
    e_start_date = Column(Date)
    e_end_date = Column(Date)
    allocation = Column(Integer)
    e_status = Column(String(100), default="Active")
    button = Column(String(100))
...
class DailyAttendanceReport(Base):
    __tablename__ = "xxits_daily_attendance_report_t"
    ...
    Late_By = Column(Text)
    Early_By = Column(Text)
    Status = Column(Text)
    Punch_Records = Column(Text)
...
class RolePrivilege(Base):
    __tablename__ = "xxits_role_privilage_t"

    rpd_id = Column(Integer, primary_key=True, autoincrement=True)
    mod_id = Column(String(255))
    role_prv_ref_no = Column(String(100))
    role_prv_name = Column(String(100))
    description = Column(String(100))
    status = Column(String(20))
    attribute_category = Column(String(240))
    admin_prv = Column(String(240))
